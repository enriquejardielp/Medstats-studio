...
const RegisterPage: React.FC = () => {
  ...
  return (
    <>
      {/* Estilos críticos para el fondo animado (compartidos con el login) */}
      <style>{`
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: '28rem', padding: '0 1rem' }}>
          <div style={{
            ...
            <h1 style={{ color: 'white', textAlign: 'center', fontWeight: 'bold', fontSize: '1.5rem' }}>Crear cuenta</h1>
            <p style={{ color: 'rgba(255,255,255,0.7)', textAlign: 'center', fontSize: '0.875rem', marginTop: '0.25rem' }}>
              Comienza a analizar tus datos clínicos
            </p>
            ...
            <p style={{ color: 'rgba(255,255,255,0.7)', textAlign: 'center', fontSize: '0.875rem', marginTop: '1.5rem' }}>
              ¿Ya tienes cuenta?{' '}
              <Link to="/login" style={{ color: 'white', fontWeight: 500, textDecoration: 'underline', textUnderlineOffset: '2px' }}>
                Inicia sesión
              </Link>
            </p>
          </div>
